...
---
## Note: subseted data - 200 cases with indicators (see line 222) - took 8 min to run
...
df1 <-
  cr_s3_df_lvlAdj_left %>%
  select(c(1, 10:25)) %>%
  slice(1:200) # only the first 200 rows - 8 minutes to run
...
### Took 8 min to run 200 original cases
```{r}
