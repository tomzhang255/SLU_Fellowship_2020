---
title: "Processing right deck"
author: "Tom Zhang"
date: "6/8/2020"
output: html_document
---

# Need card indicators and card numeric levels for right deck
...
# now add right card levels with their corresponding adjustments
  mutate(
...
# now, keep only right deck information
cr_s3_df_lvlAdj_right <-
cr_s3_df_lvlAdj %>%
  select(1:4, 26:46)
...
## Creating indicator variables for cards and levels - right deck
```{r}
...
## Join cleaned original df with deck/lvl df for only right deck
```{r}
cr_s3_df_ind_right <- left_join(cr_s3_df_lvlAdj_right, deckLvl, by = "id")
cr_s3_df_ind_right
```
...
## Saving fianl df
```{r}
write_csv(cr_s3_df_ind_right, path = "data/cr_s3_df_ind_right.csv")
```
