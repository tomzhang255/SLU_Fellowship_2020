...
# fit model
logit_s11_winsor_43_60_int <- glm(formula = f, data = cr, family = "binomial")

saveRDS(logit_s11_winsor_43_60_int, file = "logit_s11_winsor_43_60_int.rds")

rm(logit_s11_winsor_43_60_int)
