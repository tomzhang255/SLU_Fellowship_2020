...
# fit model
logit_s11_winsor_43_60_int_quad <- glm(formula = f, data = cr, family = "binomial")

saveRDS(logit_s11_winsor_43_60_int_quad, file = "logit_s11_winsor_43_60_int_quad.rds")

rm(logit_s11_winsor_43_60_int_quad)
