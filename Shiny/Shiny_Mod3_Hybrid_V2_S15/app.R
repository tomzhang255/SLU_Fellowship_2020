...
# the model
mod3 <- readRDS("mod_4000_s15_lm_2_strip.rds")
...
# for card icons
cr_cards_s15 <- read_csv("cr_cards_s15.csv")
cr_cards_s15 <- 
  cr_cards_s15 %>%
  arrange(name)

cards_s15 <- cr_cards_s15$name
...
cardProfiles <- read_csv("cr_allcard_profiles_s15.csv")
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          fluidRow(column(12, tags$h4(tags$em("Note: This app was last updated on 10/10/2020")))),
    ...
    f7Tabs(
      ...
      f7Tab(
        ...
        f7Card(
          ...
          footer = 
            tags$em("Note: This app was last updated on 10/10/2020.", tagList('And if you have any feedback to help us improve the site, please visit the Google Form at:', f7Link(label = "https://forms.gle/et4joTJgr151Chqk9", src = "https://forms.gle/et4joTJgr151Chqk9", external = TRUE)))
        ),
        f7Card(
...
serv_calc[[8]] <- function(input, sess) {
  ...
  observeEvent(input$resetM, {
    ...
    #output$opRouteLv5 <- renderRHandsontable({
    valuesM$hot <- NULL
    valuesM$hot <- rhandsontable(valuesM$DF, manualRowMove = F)
    #values$hot
    #})
  })
}
...
output$card1Icon <- function(input, sess) {
  renderUI({
    for (icon1 in 1:length(cards_s15)) {
      if (cards_s15[icon1] == input$card1Lv5) {
        icon1URL <-  cr_cards_s15$iconUrl[icon1]
      }
    }
...
output$card2Icon <- function(input, sess) {
  renderUI({
    for (icon2 in 1:length(cards_s15)) {
      if (cards_s15[icon2] == input$card2Lv5) {
        icon2URL <-  cr_cards_s15$iconUrl[icon2]
      }
    }
...
output$card3Icon <- function(input, sess) {
  renderUI({
    for (icon3 in 1:length(cards_s15)) {
      if (cards_s15[icon3] == input$card3Lv5) {
        icon3URL <-  cr_cards_s15$iconUrl[icon3]
      }
    }
...
output$card4Icon <- function(input, sess) {
  renderUI({
    for (icon4 in 1:length(cards_s15)) {
      if (cards_s15[icon4] == input$card4Lv5) {
        icon4URL <-  cr_cards_s15$iconUrl[icon4]
      }
    }
...
output$card5Icon <- function(input, sess) {
  renderUI({
    for (icon5 in 1:length(cards_s15)) {
      if (cards_s15[icon5] == input$card5Lv5) {
        icon5URL <-  cr_cards_s15$iconUrl[icon5]
      }
    }
...
output$card6Icon <- function(input, sess) {
  renderUI({
    for (icon6 in 1:length(cards_s15)) {
      if (cards_s15[icon6] == input$card6Lv5) {
        icon6URL <-  cr_cards_s15$iconUrl[icon6]
      }
    }
...
output$card7Icon <- function(input, sess) {
  renderUI({
    for (icon7 in 1:length(cards_s15)) {
      if (cards_s15[icon7] == input$card7Lv5) {
        icon7URL <-  cr_cards_s15$iconUrl[icon7]
      }
    }
...
output$card8Icon <- function(input, sess) {
  renderUI({
    for (icon8 in 1:length(cards_s15)) {
      if (cards_s15[icon8] == input$card8Lv5) {
        icon8URL <-  cr_cards_s15$iconUrl[icon8]
      }
    }
...
output$card1IconD2 <- function(input, sess) {
  renderUI({
    for (icon1D2 in 1:length(cards_s15)) {
      if (cards_s15[icon1D2] == input$card1Rv5) {
        icon1URLD2 <-  cr_cards_s15$iconUrl[icon1D2]
      }
    }
...
output$card2IconD2 <- function(input, sess) {
  renderUI({
    for (icon2D2 in 1:length(cards_s15)) {
      if (cards_s15[icon2D2] == input$card2Rv5) {
        icon2URLD2 <-  cr_cards_s15$iconUrl[icon2D2]
      }
    }
...
output$card3IconD2 <- function(input, sess) {
  renderUI({
    for (icon3D2 in 1:length(cards_s15)) {
      if (cards_s15[icon3D2] == input$card3Rv5) {
        icon3URLD2 <-  cr_cards_s15$iconUrl[icon3D2]
      }
    }
...
output$card4IconD2 <- function(input, sess) {
  renderUI({
    for (icon4D2 in 1:length(cards_s15)) {
      if (cards_s15[icon4D2] == input$card4Rv5) {
        icon4URLD2 <-  cr_cards_s15$iconUrl[icon4D2]
      }
    }
...
output$card5IconD2 <- function(input, sess) {
  renderUI({
    for (icon5D2 in 1:length(cards_s15)) {
      if (cards_s15[icon5D2] == input$card5Rv5) {
        icon5URLD2 <-  cr_cards_s15$iconUrl[icon5D2]
      }
    }
...
output$card6IconD2 <- function(input, sess) {
  renderUI({
    for (icon6D2 in 1:length(cards_s15)) {
      if (cards_s15[icon6D2] == input$card6Rv5) {
        icon6URLD2 <-  cr_cards_s15$iconUrl[icon6D2]
      }
    }
...
output$card7IconD2 <- function(input, sess) {
  renderUI({
    for (icon7D2 in 1:length(cards_s15)) {
      if (cards_s15[icon7D2] == input$card7Rv5) {
        icon7URLD2 <-  cr_cards_s15$iconUrl[icon7D2]
      }
    }
...
output$card8IconD2 <- function(input, sess) {
  renderUI({
    for (icon8D2 in 1:length(cards_s15)) {
      if (cards_s15[icon8D2] == input$card8Rv5) {
        icon8URLD2 <-  cr_cards_s15$iconUrl[icon8D2]
      }
    }
...
output$card1IconM <- function(input, sess) {
  renderUI({
    for (icon1 in 1:length(cards_s15)) {
      if (cards_s15[icon1] == input$card1Lv5M) {
        icon1URL <-  cr_cards_s15$iconUrl[icon1]
      }
    }
...
output$card2IconM <- function(input, sess) {
  renderUI({
    for (icon2 in 1:length(cards_s15)) {
      if (cards_s15[icon2] == input$card2Lv5M) {
        icon2URL <-  cr_cards_s15$iconUrl[icon2]
      }
    }
...
output$card3IconM <- function(input, sess) {
  renderUI({
    for (icon3 in 1:length(cards_s15)) {
      if (cards_s15[icon3] == input$card3Lv5M) {
        icon3URL <-  cr_cards_s15$iconUrl[icon3]
      }
    }
...
output$card4IconM <- function(input, sess) {
  renderUI({
    for (icon4 in 1:length(cards_s15)) {
      if (cards_s15[icon4] == input$card4Lv5M) {
        icon4URL <-  cr_cards_s15$iconUrl[icon4]
      }
    }
...
output$card5IconM <- function(input, sess) {
  renderUI({
    for (icon5 in 1:length(cards_s15)) {
      if (cards_s15[icon5] == input$card5Lv5M) {
        icon5URL <-  cr_cards_s15$iconUrl[icon5]
      }
    }
...
output$card6IconM <- function(input, sess) {
  renderUI({
    for (icon6 in 1:length(cards_s15)) {
      if (cards_s15[icon6] == input$card6Lv5M) {
        icon6URL <-  cr_cards_s15$iconUrl[icon6]
      }
    }
...
output$card7IconM <- function(input, sess) {
  renderUI({
    for (icon7 in 1:length(cards_s15)) {
      if (cards_s15[icon7] == input$card7Lv5M) {
        icon7URL <-  cr_cards_s15$iconUrl[icon7]
      }
    }
...
output$card8IconM <- function(input, sess) {
  renderUI({
    for (icon8 in 1:length(cards_s15)) {
      if (cards_s15[icon8] == input$card8Lv5M) {
        icon8URL <-  cr_cards_s15$iconUrl[icon8]
      }
    }
...
output$card1IconD2M <- function(input, sess) {
  renderUI({
    for (icon1D2 in 1:length(cards_s15)) {
      if (cards_s15[icon1D2] == input$card1Rv5M) {
        icon1URLD2 <-  cr_cards_s15$iconUrl[icon1D2]
      }
    }
...
output$card2IconD2M <- function(input, sess) {
  renderUI({
    for (icon2D2 in 1:length(cards_s15)) {
      if (cards_s15[icon2D2] == input$card2Rv5M) {
        icon2URLD2 <-  cr_cards_s15$iconUrl[icon2D2]
      }
    }
...
output$card3IconD2M <- function(input, sess) {
  renderUI({
    for (icon3D2 in 1:length(cards_s15)) {
      if (cards_s15[icon3D2] == input$card3Rv5M) {
        icon3URLD2 <-  cr_cards_s15$iconUrl[icon3D2]
      }
    }
...
output$card4IconD2M <- function(input, sess) {
  renderUI({
    for (icon4D2 in 1:length(cards_s15)) {
      if (cards_s15[icon4D2] == input$card4Rv5M) {
        icon4URLD2 <-  cr_cards_s15$iconUrl[icon4D2]
      }
    }
...
output$card5IconD2M <- function(input, sess) {
  renderUI({
    for (icon5D2 in 1:length(cards_s15)) {
      if (cards_s15[icon5D2] == input$card5Rv5M) {
        icon5URLD2 <-  cr_cards_s15$iconUrl[icon5D2]
      }
    }
...
output$card6IconD2M <- function(input, sess) {
  renderUI({
    for (icon6D2 in 1:length(cards_s15)) {
      if (cards_s15[icon6D2] == input$card6Rv5M) {
        icon6URLD2 <-  cr_cards_s15$iconUrl[icon6D2]
      }
    }
...
output$card7IconD2M <- function(input, sess) {
  renderUI({
    for (icon7D2 in 1:length(cards_s15)) {
      if (cards_s15[icon7D2] == input$card7Rv5M) {
        icon7URLD2 <-  cr_cards_s15$iconUrl[icon7D2]
      }
    }
...
output$card8IconD2M <- function(input, sess) {
  renderUI({
    for (icon8D2 in 1:length(cards_s15)) {
      if (cards_s15[icon8D2] == input$card8Rv5M) {
        icon8URLD2 <-  cr_cards_s15$iconUrl[icon8D2]
      }
    }
