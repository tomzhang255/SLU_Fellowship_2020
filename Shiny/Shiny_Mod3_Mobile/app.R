...
shiny::shinyApp(
      ...
      f7Tabs(
        ...
        f7Tab(
          ...
          f7Card(
            ...
            footer = tags$em("Note: This app was last updated on 7/7/2020")
          ),
          f7Card(
        ...
        f7Tab(
          ...
          f7Card(
            ...
            footer = f7Tooltip(tag = f7Badge("Tips", color = "orange"),
                               text = f7Col(
                                 f7Row("Try Tommy Z-7's Deck: #9YJUPU9LY"),
                                 f7Row("Try Morderth's Deck: #9U9Y02GPL"),
                                 f7Row("Try PatienceV's Deck: #P9Y9VV2VC"),
                               )
                                 )
          ),
          f7Card(
        ...
        f7Tab(
          ...
          f7Card(
            ...
            plotOutput(outputId = "barv5", height = "300px")
          ),
          f7Card(
            title = "Interpretation",
            textOutput(outputId = "interpretNote")
          )
        ...
        f7Tab(
          ...
          f7Card(
            ...
            f7Button(inputId = "viewUpdate", label = "View Route / Update Plot"),
            footer = f7Button(inputId = "reset", label = "Reset")
          ),
          f7Card(
            rHandsontableOutput(outputId = "opRouteLv5"),
            footer = textOutput(outputId = "noteRoute")
          ),
          f7Card(
            textOutput(outputId = "plotTitle"),
            plotlyOutput(outputId = "geomLine")
          )
  ...
  server <- function(input, output) {
    ...
    output$interpretNote <- renderText({
      paste("For instance,", values$left95, "is the estimated 95th percentile trophy rating for all players using Deck 1. If you are above that rating, then you are in the top 5% of players with a similar deck.")
    })
